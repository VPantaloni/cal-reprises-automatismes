...
def selectionner_automatismes_34(
...
def selectionner_automatismes_theme_56(
    data, semaine, theme, auto_weeks, used_codes, codes_selectionnes,
    min_espacement_rappel, espacement_min2, espacement_max2, espacement_min3, espacement_max3,
    themes_passes
):
...
def selectionner_automatismes(
    ...
    # Compléter les cases vides si besoin (dépassement possible des 3 reprises, non rappels uniquement)
    for i in range(6):
